    ...
    <div className="min-h-screen flex items-center justify-center flex-col space-y-6">
      ...
      <div className="flex flex-col space-y-3">
        <button
          ...
          className="inline-flex items-center space-x-4 px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
        >
        ...
        <button
          ...
          className="inline-flex items-center space-x-4 px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
        >
          <svg
