...
var ACCESS_TOKEN_LIFETIME_SECONDS = 600;
var REFRESH_TOKEN_LIFETIME_SECONDS = 28800;
var REFRESH_TOKEN_RECLAIMTIME_SECONDS = 604800;
var GRACE_PERIOD_SECONDS = 20;
function CreateAccessToken(instance, refreshTokenRef) {
  return Create2(Tokens(), {
    instance,
    data: {
      type: "access",
...
function CreateRefreshToken(userRef) {
  return Create2(Tokens(), {
    instance: userRef,
    data: {
      type: "refresh",
...
function CreateAccessAndRefreshToken(userRef) {
  return Let({
...
function CreateOrReuseId() {
  return (0, import_faunadb2.If)(IsCalledWithRefreshToken(), GetSessionId(), NewId());
}
function GetSessionId() {
  return Select(["data", "sessionId"], Get(CurrentToken2()));
}
function RotateAccessAndRefreshToken() {
  return Do2(InvalidateRefreshToken(CurrentToken2()), CreateAccessAndRefreshToken(CurrentIdentity2()));
}
function IsCalledWithRefreshToken() {
  return And(HasCurrentToken(), Equals(Select(["data", "type"], Get(CurrentToken2()), false), "refresh"));
}
...
var {CurrentIdentity: CurrentIdentity3, Get: Get2} = q3;
function RefreshToken() {
  return VerifyRefreshToken({
    tokens: RotateAccessAndRefreshToken(),
    user: Get2(CurrentIdentity3())
  }, "refresh");
}

// fauna/resources/functions/refresh.js
var refresh_default = (0, import_faunadb4.CreateFunction)({
  name: "refresh",
  body: (0, import_faunadb4.Query)((0, import_faunadb4.Lambda)([], RefreshToken())),
  role: "server"
});
