...
var require_query = __commonJS((exports2, module2) => {
  ...
  function If2(condition, then, _else) {
    arity.exact(3, arguments, If2.name);
    return new Expr({if: wrap(condition), then: wrap(then), else: wrap(_else)});
  }
  function Do2() {
    arity.min(1, arguments, Do2.name);
  ...
  function Lambda2() {
    arity.between(1, 2, arguments, Lambda2.name);
    switch (arguments.length) {
      case 1:
  ...
  function Get3(ref, ts) {
    arity.between(1, 2, arguments, Get3.name);
  ...
  function CreateRole2(params2) {
    arity.exact(1, arguments, CreateRole2.name);
  ...
  function Events2(ref_set) {
    arity.exact(1, arguments, Events2.name);
  ...
  function CurrentIdentity3() {
    arity.exact(0, arguments, CurrentIdentity3.name);
  ...
  function CurrentToken2() {
    arity.exact(0, arguments, CurrentToken2.name);
  ...
  function Equals3() {
    arity.min(1, arguments, Equals3.name);
  ...
  function Select3(path, from, _default) {
    arity.between(2, 3, arguments, Select3.name);
  ...
  module2.exports = {
    ...
    CurrentIdentity: CurrentIdentity3,
...
function IsCalledWithRefreshToken() {
  return And(HasCurrentToken(), Equals(Select(["data", "type"], Get(CurrentToken()), false), "refresh"));
}

// fauna/resources/roles/refresh.js
var refresh_default = (0, import_faunadb3.CreateRole)({
  name: "refresh",
  membership: [
    {
      resource: (0, import_faunadb3.Collection)("users"),
      predicate: (0, import_faunadb3.Query)((0, import_faunadb3.Lambda)((_ref) => IsCalledWithRefreshToken()))
    }
  ],
  privileges: [
    {
      resource: (0, import_faunadb3.Collection)("rate_limiting"),
      actions: {
        read: (0, import_faunadb3.Query)((ref) => (0, import_faunadb3.Equals)((0, import_faunadb3.CurrentIdentity)(), (0, import_faunadb3.Select)(["data", "identity"], (0, import_faunadb3.Get)(ref)))),
        write: (0, import_faunadb3.Query)((_oldData, newData) => (0, import_faunadb3.Equals)((0, import_faunadb3.CurrentIdentity)(), (0, import_faunadb3.Select)(["data", "identity"], newData))),
        create: (0, import_faunadb3.Query)((newData) => (0, import_faunadb3.Equals)((0, import_faunadb3.CurrentIdentity)(), (0, import_faunadb3.Select)(["data", "identity"], newData)))
      }
    },
    {
      resource: (0, import_faunadb3.Events)(),
      actions: {
        unrestricted_read: true
      }
    },
    {
      resource: (0, import_faunadb3.Index)("rate_limiting_by_action_and_identity"),
      actions: {
        unrestricted_read: true
      }
    },
    {
      resource: (0, import_faunadb3.Function)("refresh"),
      actions: {
        call: true
      }
    },
    {
      resource: (0, import_faunadb3.Function)("logout"),
      actions: {
        call: true
      }
    }
